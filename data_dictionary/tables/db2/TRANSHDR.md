...
Header chứng từ giao dịch gần đây (db2) — cùng schema TRANSHDR_ARC. Bill bán lẻ thường TRANS_CODE=113.

**Liên kết:** TRANS_NUM + TRANS_CODE → STRANS, PMTRANS

**Lưu ý:** Giao dịch ~2 tháng gần nhất. cutoff = ngày 1 của tháng trước (so với ngày chạy query). Ví dụ hôm nay 22/06/2026 → cutoff = 2026-05-01.
