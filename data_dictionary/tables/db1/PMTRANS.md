...
**Lưu ý:** Lịch sử trước cutoff; chọn shard YYYYMM theo TRAN_DATE. cutoff = ngày 1 của tháng trước (so với ngày chạy query). Ví dụ hôm nay 22/06/2026 → cutoff = 2026-05-01. 008 thường có AMOUNT âm (chi quỹ).
