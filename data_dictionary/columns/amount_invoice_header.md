...
Số tiền / giá trị — grain phụ thuộc bảng. TRANSHDR = tổng bill; STRANS = thành tiền dòng; PMTRANS = thanh toán; CRDTRANS = doanh thu tích điểm. Chỉ xuất hiện trên header hóa đơn mua / nhập.

## Bảng & vai trò

| Bảng | Cột | Kiểu | Vai trò |
|------|-----|------|---------|
| `db2:inv_hdr` | `AMOUNT` | numeric | Thành tiền / số tiền (ngữ cảnh theo bảng) |
